...
class ResetPasswordScreen extends StatefulWidget {
  final String email;
  final Widget nextScreenAfterReset;

  const ResetPasswordScreen({super.key, required this.email, required this.nextScreenAfterReset});
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          "Enter OTP sent to ${widget.email} and your new password.",
                          textAlign: TextAlign.center,
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            prefixIcon: const Icon(Icons.lock, color: Color(0xFF5A6B87), size: 20),
                          ...
                          listener: (context, state) {
                            if (state is SharedAuthSuccess) {
                              ...
                              Navigator.pushAndRemoveUntil(
                                context,
                                MaterialPageRoute(builder: (context) => widget.nextScreenAfterReset),
                                (route) => false,
                              );
                              ...
                              onPressed: state is SharedAuthLoading
                                  ...
                                  : () {
                                      if (_formKey.currentState!.validate()) {
                                        context.read<SharedAuthCubit>().resetPassword(
                                          email: widget.email,
