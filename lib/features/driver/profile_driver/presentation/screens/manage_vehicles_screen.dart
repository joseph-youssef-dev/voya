...
import 'package:voya/features/driver/profile_driver/presentation/widgets/vehicle_form_dialog.dart';
...
class ManageVehiclesScreen extends StatelessWidget {
                    ...
                    if (state is DriverProfileSuccess) {
                      ...
                      return ListView.separated(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return _buildManageVehicleCard(
                            context,
                            vehicle,
                            cubit,
                          );
  ...
  Widget _buildManageVehicleCard(
    BuildContext context,
    VehicleModel vehicle,
    DriverProfileCubit cubit,
  ) {
    return Container(
      padding: const EdgeInsets.all(20),
              ...
              IconButton(
                onPressed: () {
                  showDialog(
                    context: context,
                    builder: (_) =>
                        VehicleFormDialog(vehicle: vehicle, cubit: cubit),
                  );
                },
                icon: const Icon(
                  Icons.edit,
