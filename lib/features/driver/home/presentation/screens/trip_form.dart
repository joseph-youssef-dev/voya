...
import 'package:voya/features/driver/home/presentation/widgets/trip_widgets.dart';
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<AddTripCubit, AddTripState>(
      builder: (context, state) {
        ...
        if (_durationController.text != state.duration &&
            ...
            child: SafeArea(
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    CustomHeader(
                      title: state.tripId != null ? 'Edit Trip' : 'Post a Trip',
                    ),
