                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              border: Border.all(color: const Color(0xFFAAB8D2)),
                            ),
                            child: _licenseImage != null
                                ...
                                : const Icon(Icons.add_a_photo, color: Color(0xFF0D32B3), size: 40),
                          ),
                        ),
                        const SizedBox(height: 40),
                            ...
                            GestureDetector(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  color: const Color(0xFFF1F4F9),
                                  borderRadius: BorderRadius.circular(12),
                                  border: Border.all(color: const Color(0xFFAAB8D2), style: BorderStyle.solid),
                                ),
                                child: const Icon(Icons.add_photo_alternate, color: Color(0xFF0D32B3)),
                              ),
                            ),
                          ],
                        ),
