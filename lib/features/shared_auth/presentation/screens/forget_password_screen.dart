...
class ForgetPasswordScreen extends StatefulWidget {
  ...
  const ForgetPasswordScreen({super.key, required this.nextScreenAfterReset});
                      ...
                      children: [
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            prefixIcon: const Icon(Icons.email, color: Color(0xFF5A6B87), size: 20),
                            filled: true,
                              ...
                              Navigator.pushReplacement(
                                ...
                                MaterialPageRoute(
                                  builder: (context) => ResetPasswordScreen(
                                    ...
                                    nextScreenAfterReset: widget.nextScreenAfterReset,
                                  ),
                                ),
                              );
                              ...
                              onPressed: state is SharedAuthLoading
                                  ...
                                  : () {
                                      if (_formKey.currentState!.validate()) {
                                        context.read<SharedAuthCubit>().forgetPassword(
                                          email: _emailController.text.trim(),
                                        );
                                      }
                                    },
